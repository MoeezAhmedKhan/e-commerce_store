                ...
                <div class="card-body">
                    ...
                    <table id="example" class="table table-bordered dt-responsive table-responsive nowrap">
                        ...
                        <tbody>
                            ...
                            $select = "SELECT p.id,p.product_name,p.price,p.image,p.created_at,c.category_name FROM product p INNER JOIN category c on c.id = p.category_id WHERE p.is_slider = 'no'";
    ...
    <div id="modal">
                <div id="modal-form">
                    ...
                    <form method="POST" action="phpfiles/action.php" enctype="multipart/form-data">
                        ...
                        <button type="submit" class="btn btn-primary btn-lg" name="update_pro_btn">Update</button>
                    </form>
