<?php 
    ...
    $select = "SELECT id, product_name, category_id, price, image, created_at FROM product WHERE price BETWEEN $minprice AND $maxprice AND category_id = $cid";
    ...
    {
        echo "No product found for this price";
    }
